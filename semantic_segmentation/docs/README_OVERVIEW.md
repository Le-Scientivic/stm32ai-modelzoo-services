...
Please refer to [the data augmentation documentation](./README_DATA_AUGMENTATION.md) for a list of functions that are available and the transforms they apply to the input images.
