...
from common.utils import (
        ...
        parse_deployment_section, check_hardware_type, parse_evaluation_section, parse_model_section)
...
def parse_dataset_section(cfg: DictConfig, mode: str = None, mode_groups: DictConfig = None, hardware_type: str = None) -> None:
    ...
    legal = ["dataset_name", "training_path", "training_masks_path",
             "validation_path", "validation_masks_path","validation_split",
             "test_path", "test_masks_path", "prediction_path",
...
def get_config(config_data: DictConfig) -> DefaultMunch:
    ...
    mode_groups = DefaultMunch.fromDict({
        ...
        "compression": ["training", "compression"]
    })
    ...
    cfg.use_case = 'depth_estimation'
    # Model section parsing
    legal=["framework", "model_type", "model_name", "input_shape", "model_path"]
