...
def preprocess(cfg: DictConfig = None) -> Tuple:
    ...
    if cfg.model.model_path:
        _, input_shape = get_model_name_and_its_input_shape(cfg.model.model_path)
    else:
    ...
    train_ds, valid_ds, quantization_ds, test_query_ds, test_gallery_ds = load_dataset(
        ...
        test_query_path=cfg.dataset.test_query_path,
        test_gallery_path=cfg.dataset.test_gallery_path,
        validation_split=cfg.dataset.validation_split,
        class_names=cfg.dataset.class_names,
        class_names_test=cfg.dataset.class_names_test,
        image_size= input_shape[1:] if cfg.model.model_path and cfg.model.model_path.split('.')[-1]=='onnx' else input_shape[:2],
    ...
    return train_ds, valid_ds, quantization_ds, test_query_ds, test_gallery_ds
