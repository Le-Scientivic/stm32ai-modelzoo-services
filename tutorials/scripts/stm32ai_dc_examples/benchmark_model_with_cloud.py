...
from common.stm32ai_dc.types import MpuParameters
...
model_name = 'mobilenet_v1_0.25_96.h5'
...
try:
    target_board = 'STM32H747I-DISCO'
    res = ai.benchmark(CliParameters(model=model_name), target_board)
    # Print results
    print(f"Result from cloud file at {target_board}: {res}")
    # Delete model
